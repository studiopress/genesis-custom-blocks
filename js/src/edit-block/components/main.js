 ...
 */
const Main = ( { children, editorMode, setEditorMode, template } ) => {
	// @ts-ignore
	...
	return (
		<div className="flex flex-col flex-grow items-start w-full overflow-scroll">
			<div className="flex flex-col w-full max-w-2xl mx-auto pl-8 pr-8 pb-64">
				...
				<TopNotice editorMode={ editorMode } setEditorMode={ setEditorMode } template={ template } isOnboarding={ isOnboarding } />
				{ children }
