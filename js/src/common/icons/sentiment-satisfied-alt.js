...
/**
 * The SentimentSatisfiedAlt icon.
 *
 * @return {React.ReactElement} The SentimentSatisfiedAlt icon.
 */
const SentimentSatisfiedAlt = () => (
	<SvgContainer>
		<path fill="none" d="M0 0h24v24H0V0z" /><circle cx="15.5" cy="9.5" r="1.5" /><circle cx="8.5" cy="9.5" r="1.5" />
