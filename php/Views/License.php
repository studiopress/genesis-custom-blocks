		...
		<tr valign="top">
			...
			<td>
				...
				if ( genesis_custom_blocks()->is_pro() ) {
					printf(
						'<p>%1$s</p>',
						esc_html__( 'Your Genesis Pro license is valid.', 'genesis-custom-blocks' )
					);
				} else {
					printf(
						'<p>%1$s %2$s</p>',
						esc_html__( 'No Genesis Pro license was found for this installation.', 'genesis-custom-blocks' ),
						sprintf(
